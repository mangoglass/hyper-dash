...
var OutlineRenderer = /** @class */ (function () {
    ...
    function OutlineRenderer(scene) {
        ...
        this._nameForDrawWrapper = "bjs_outlinerenderer_" + OutlineRenderer._Counter++;
    }
    /**
    ...
    OutlineRenderer.prototype.render = function (subMesh, batch, useOverlay) {
        ...
        var drawWrapper = subMesh._getDrawWrapper(this._nameForDrawWrapper);
    ...
    OutlineRenderer.prototype.isReady = function (subMesh, useInstances) {
        ...
        var subMeshEffect = subMesh._getDrawWrapper(this._nameForDrawWrapper, true);
        ...
        if (cachedDefines !== join) {
            cachedDefines = join;
            effect = this.scene.getEngine().createEffect("outline", attribs, ["world", "mBones", "viewProjection", "diffuseMatrix", "offset", "color", "logarithmicDepthConstant",
                "morphTargetInfluences", "morphTargetTextureInfo", "morphTargetTextureIndices"], ["diffuseSampler", "morphTargets"], join, undefined, undefined, undefined, { maxSimultaneousMorphTargets: numMorphInfluencers });
        }
