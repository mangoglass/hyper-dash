...
var DepthRenderer = /** @class */ (function () {
    ...
    function DepthRenderer(scene, type, camera, storeNonLinearDepth) {
        ...
        var renderSubMesh = function (subMesh) {
            ...
            if (_this.isReady(subMesh, hardwareInstancedRendering) && camera) {
                ...
                var drawWrapper = subMesh._getDrawWrapper(_this._nameForDrawWrapper);
    ...
    DepthRenderer.prototype.isReady = function (subMesh, useInstances) {
        ...
        if (cachedDefines !== join) {
            cachedDefines = join;
            effect = engine.createEffect("depth", attribs, ["world", "mBones", "viewProjection", "diffuseMatrix", "depthValues", "morphTargetInfluences", "morphTargetTextureInfo", "morphTargetTextureIndices"], ["diffuseSampler", "morphTargets"], join, undefined, undefined, undefined, { maxSimultaneousMorphTargets: numMorphInfluencers });
        }
