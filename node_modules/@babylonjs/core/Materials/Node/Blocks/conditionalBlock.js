...
var ConditionalBlock = /** @class */ (function (_super) {
    ...
    ConditionalBlock.prototype._dumpPropertiesCode = function () {
        var codeString = _super.prototype._dumpPropertiesCode.call(this) + (this._codeVariableName + ".operation = BABYLON.ConditionalBlockConditions." + ConditionalBlockConditions[this.condition] + ";\r\n");
        return codeString;
    };
    return ConditionalBlock;
}(NodeMaterialBlock));
