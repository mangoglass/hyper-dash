...
var RenderTargetTexture = /** @class */ (function (_super) {
    ...
    RenderTargetTexture.prototype.createDepthStencilTexture = function (comparisonFunction, bilinearFiltering, generateStencil, samples) {
        ...
        (_a = internalTexture._depthStencilTexture) === null || _a === void 0 ? void 0 : _a.dispose();
    ...
    RenderTargetTexture.prototype.renderToTarget = function (faceIndex, useCameraPostProcess, dumpForDebug, layer, camera) {
        ...
        if (!fastPath) {
            ...
            // Before clear
            for (var _i = 0, _c = scene._beforeRenderTargetClearStage; _i < _c.length; _i++) {
                var step = _c[_i];
            ...
            // Before Camera Draw
            for (var _d = 0, _e = scene._beforeRenderTargetDrawStage; _d < _e.length; _d++) {
                var step = _e[_d];
                step.action(this, faceIndex, layer);
            }
            // Render
            ...
            // After Camera Draw
            for (var _f = 0, _g = scene._afterRenderTargetDrawStage; _f < _g.length; _f++) {
                var step = _g[_f];
                step.action(this, faceIndex, layer);
            }
