...
var CubeTexture = /** @class */ (function (_super) {
    ...
    * @return the cube texture
    ...
    function CubeTexture(rootUrl, sceneOrEngine, extensions, noMipmap, files, onLoad, onError, format, prefiltered, forcedExtension, createPolynomials, lodScale, lodOffset, loaderOptions, useSRGBBuffer) {
        ...
        _this._texture = _this._getFromCache(rootUrl, noMipmap, undefined, undefined, useSRGBBuffer);
        if (!files) {
        ...
        if (!_this._texture) {
            ...
            if (!(scene === null || scene === void 0 ? void 0 : scene.useDelayedTextureLoading)) {
                if (prefiltered) {
                    ...
                    _this._texture = _this._getEngine().createCubeTexture(rootUrl, scene, files, noMipmap, onLoad, onError, _this._format, forcedExtension, false, lodScale, lodOffset, null, loaderOptions, !!_this._useSRGBBuffer);
                }
