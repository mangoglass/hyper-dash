...
var BaseTexture = /** @class */ (function (_super) {
     ...
     */
    BaseTexture.prototype.readPixels = function (faceIndex, level, buffer, flushRenderer) {
    ...
    /** @hidden */
    BaseTexture.prototype._readPixelsSync = function (faceIndex, level, buffer, flushRenderer) {
        if (faceIndex === void 0) { faceIndex = 0; }
        if (level === void 0) { level = 0; }
        if (buffer === void 0) { buffer = null; }
        if (flushRenderer === void 0) { flushRenderer = true; }
