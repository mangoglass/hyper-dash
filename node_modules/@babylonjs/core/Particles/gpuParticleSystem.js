...
var GPUParticleSystem = /** @class */ (function (_super) {
    ...
    function GPUParticleSystem(name, options, sceneOrEngine, customEffect, isAnimationSheetEnabled) {
        ...
        if (_this._engine.getCaps().supportComputeShaders) {
            ...
            _this._platform = new _TypeStore.RegisteredTypes["BABYLON.ComputeShaderParticleSystem"](_this, _this._engine);
        }
        else {
            ...
            _this._platform = new _TypeStore.RegisteredTypes["BABYLON.WebGL2ParticleSystem"](_this, _this._engine);
        }
    ...
    GPUParticleSystem.prototype._getWrapper = function (blendMode) {
        ...
        if (this._drawWrapper.defines !== join) {
            ...
            this._drawWrapper.effect = this._engine.createEffect("gpuRenderParticles", attributes, uniforms, samplers, join);
        }
    ...
    GPUParticleSystem.Parse = function (parsedParticleSystem, sceneOrEngine, rootUrl, doNotStart) {
        ...
        var particleSystem = new GPUParticleSystem(name, { capacity: parsedParticleSystem.capacity, randomTextureSize: parsedParticleSystem.randomTextureSize }, sceneOrEngine, null, parsedParticleSystem.isAnimationSheetEnabled);
