...
var ParticleSystem = /** @class */ (function (_super) {
    ...
    function ParticleSystem(name, capacity, sceneOrEngine, customEffect, isAnimationSheetEnabled, epsilon) {
        ...
        */
        ...
        _this._drawWrapper = new DrawWrapper(_this._engine);
    ...
    ParticleSystem.prototype._getWrapper = function (blendMode) {
        ...
        if (this._drawWrapper.defines !== join) {
            ...
            this._drawWrapper.effect = this._engine.createEffect("particles", attributesNamesOrOptions, effectCreationOption, samplers, join);
        }
    ...
    ParticleSystem._Parse = function (parsedParticleSystem, particleSystem, sceneOrEngine, rootUrl) {
        ...
        if (parsedParticleSystem.colorGradients) {
            for (var _i = 0, _c = parsedParticleSystem.colorGradients; _i < _c.length; _i++) {
                var colorGradient = _c[_i];
        ...
        if (parsedParticleSystem.rampGradients) {
            for (var _d = 0, _e = parsedParticleSystem.rampGradients; _d < _e.length; _d++) {
                var rampGradient = _e[_d];
        ...
        if (parsedParticleSystem.colorRemapGradients) {
            for (var _f = 0, _g = parsedParticleSystem.colorRemapGradients; _f < _g.length; _f++) {
                var colorRemapGradient = _g[_f];
        ...
        if (parsedParticleSystem.alphaRemapGradients) {
            for (var _h = 0, _j = parsedParticleSystem.alphaRemapGradients; _h < _j.length; _h++) {
                var alphaRemapGradient = _j[_h];
        ...
        particleSystem.disposeOnStop = (_a = parsedParticleSystem.disposeOnStop) !== null && _a !== void 0 ? _a : false;
        particleSystem.manualEmitCount = (_b = parsedParticleSystem.manualEmitCount) !== null && _b !== void 0 ? _b : -1;
    };
    /**
