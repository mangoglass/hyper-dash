...
var EnvironmentTextureTools = /** @class */ (function () {
    ...
    EnvironmentTextureTools.CreateEnvTextureAsync = function (texture) {
        return __awaiter(this, void 0, void 0, function () {
            var internalTexture, engine, textureType, cubeWidth, hostingScene, specularTextures, mipmapsCount, i, faceWidth, face, faceData, faceDataFloat, i_1, tempTexture, rgbdEncodedData, pngEncodedata, info, position, i, face, byteLength, infoString, infoBuffer, infoView, i, strLen, totalSize, finalBuffer, finalBufferView, dataView, pos, i, i, face, dataBuffer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        rgbdEncodedData = _a.sent();
                        return [4 /*yield*/, Tools.DumpDataAsync(faceWidth, faceWidth, rgbdEncodedData, "image/png", undefined, false, true)];
                    case 6:
                        pngEncodedata = _a.sent();
                        specularTextures[i * 6 + face] = pngEncodedata;
                        tempTexture.dispose();
                        _a.label = 7;
                    case 7:
                        face++;
                    ...
                    case 9:
                        ...
                        totalSize = EnvironmentTextureTools._MagicBytes.length + position + infoBuffer.byteLength;
                        finalBuffer = new ArrayBuffer(totalSize);
                        finalBufferView = new Uint8Array(finalBuffer);
                        dataView = new DataView(finalBuffer);
                        pos = 0;
                        for (i = 0; i < EnvironmentTextureTools._MagicBytes.length; i++) {
