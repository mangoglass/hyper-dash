...
var ScreenshotTools = /** @class */ (function () {
     ...
     */
    ScreenshotTools.CreateScreenshot = function (engine, camera, size, successCallback, mimeType, forceDownload) {
     ...
     * to the src parameter of an <img> to display it
     */
    ScreenshotTools.CreateScreenshotWithResizeAsync = function (engine, camera, width, height, mimeType) {
        if (mimeType === void 0) { mimeType = "image/png"; }
        return new Promise(function (resolve, reject) {
            ScreenshotTools.CreateScreenshot(engine, camera, { width: width, height: height }, function () {
                resolve();
            }, mimeType, true);
        });
    };
