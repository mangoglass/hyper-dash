...
var Tools = /** @class */ (function () {
     ...
     */
    Tools.DumpData = function (width, height, data, successCallback, mimeType, fileName, invertY, toArrayBuffer) {
        if (mimeType === void 0) { mimeType = "image/png"; }
     ...
     */
    Tools.DumpDataAsync = function (width, height, data, mimeType, fileName, invertY, toArrayBuffer) {
        if (mimeType === void 0) { mimeType = "image/png"; }
        if (invertY === void 0) { invertY = false; }
        if (toArrayBuffer === void 0) { toArrayBuffer = false; }
        return new Promise(function (resolve) {
            Tools.DumpData(width, height, data, function (result) { return resolve(result); }, mimeType, fileName, invertY, toArrayBuffer);
        });
    };
    /**
     ...
     */
    Tools.EncodeScreenshotCanvasData = function (successCallback, mimeType, fileName, canvas) {
        if (mimeType === void 0) { mimeType = "image/png"; }
        if (successCallback) {
            var base64Image = (canvas !== null && canvas !== void 0 ? canvas : Tools._ScreenshotCanvas).toDataURL(mimeType);
