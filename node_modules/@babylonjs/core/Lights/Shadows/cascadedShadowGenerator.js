...
var CascadedShadowGenerator = /** @class */ (function (_super) {
    ...
    function CascadedShadowGenerator(mapSize, light, usefulFloatFirst) {
        ...
        _this._nameForDrawWrapperOrig = _this._nameForDrawWrapper[0];
        return _this;
    }
    ...
    CascadedShadowGenerator.prototype._setNamesForDrawWrapper = function () {
    ...
    CascadedShadowGenerator.prototype._initializeShadowMap = function () {
        ...
        this._shadowMap.onBeforeRenderObservable.add(function (layer) {
            _this._nameForDrawWrapperCurrent = _this._nameForDrawWrapper[layer];
        ...
        this._shadowMap.onBeforeBindObservable.add(function () {
            var _a;
            (_a = engine._debugPushGroup) === null || _a === void 0 ? void 0 : _a.call(engine, "cascaded shadow map generation for " + _this._nameForDrawWrapper, 1);
