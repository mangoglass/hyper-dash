...
var ShadowGenerator = /** @class */ (function () {
    ...
    function ShadowGenerator(mapSize, light, usefulFloatFirst) {
        ...
        this._nameForDrawWrapper = ["bjs_shadowgenerator_" + ShadowGenerator._Counter++];
        if (light.needCube()) {
            var baseName = this._nameForDrawWrapper[0];
            for (var i = 0; i < 6; ++i) {
    ...
    ShadowGenerator.prototype._initializeShadowMap = function () {
        ...
        this._shadowMap.onBeforeBindObservable.add(function () {
            var _a;
            (_a = engine._debugPushGroup) === null || _a === void 0 ? void 0 : _a.call(engine, "shadow map generation for " + _this._nameForDrawWrapper, 1);
        });
        // Record Face Index before render.
        this._shadowMap.onBeforeRenderObservable.add(function (faceIndex) {
            _this._nameForDrawWrapperCurrent = _this._nameForDrawWrapper[faceIndex];
    ...
    ShadowGenerator.prototype._renderSubMeshForShadowMap = function (subMesh, isTransparent) {
        ...
        if (this.isReady(subMesh, hardwareInstancedRendering, isTransparent)) {
            ...
            var drawWrapper = (_a = shadowDepthWrapper === null || shadowDepthWrapper === void 0 ? void 0 : shadowDepthWrapper.getEffect(subMesh, this, this._nameForDrawWrapperCurrent)) !== null && _a !== void 0 ? _a : subMesh._getDrawWrapper(this._nameForDrawWrapperCurrent);
    ...
    ShadowGenerator.prototype.isReady = function (subMesh, useInstances, isTransparent) {
        ...
        if (shadowDepthWrapper) {
            ...
            var subMeshEffect = subMesh._getDrawWrapper(this._nameForDrawWrapperCurrent, true);
