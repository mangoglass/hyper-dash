...
var WebXRHand = /** @class */ (function () {
    ...
    rigMapping, _leftHandedMeshes, _jointsInvisible, _jointScaleFactor) {
        ...
        if (_handMesh) {
            ...
            _handMesh.getChildMeshes().forEach(function (mesh) { return (mesh.alwaysSelectAsActiveMesh = true); });
        }
...
var WebXRHandTracking = /** @class */ (function (_super) {
    ...
    WebXRHandTracking._generateTrackedJointMeshes = function (featureOptions) {
        ...
        ["left", "right"].map(function (handedness) {
            var _a, _b, _c, _d, _e;
            var trackedMeshes = [];
            var originalMesh = ((_a = featureOptions.jointMeshes) === null || _a === void 0 ? void 0 : _a.sourceMesh) || IcoSphereBuilder.CreateIcoSphere("jointParent", WebXRHandTracking._ICOSPHERE_PARAMS);
    ...
    WebXRHandTracking._generateDefaultHandMeshesAsync = function (scene) {
        var _this = this;
    ...
    WebXRHandTracking.prototype.attach = function () {
        ...
        if (!((_c = this.options.handMeshes) === null || _c === void 0 ? void 0 : _c.customMeshes) && !((_d = this.options.handMeshes) === null || _d === void 0 ? void 0 : _d.disableDefaultMeshes)) {
            WebXRHandTracking._generateDefaultHandMeshesAsync(Engine.LastCreatedScene).then(function (defaultHandMeshes) {
                var _a, _b;
