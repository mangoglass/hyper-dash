...
var WebXRImageTracking = /** @class */ (function (_super) {
    ...
    options) {
        ...
        if (_this.options.images.length === 0) {
            return _this;
        }
                                ...
                                var p = new Promise(function (resolve, reject) {
                                    if (typeof image.src === "string") {
                                        ...
                                        img_1.onload = function () {
                                            img_1.decode().then(function () {
                                                _this._xrSessionManager.scene.getEngine().createImageBitmap(img_1).then(function (imageBitmap) {
                                                    resolve(imageBitmap);
                                                });
                                            });
                                        };
    ...
    WebXRImageTracking.prototype._init = function () {
        return __awaiter(this, void 0, void 0, function () {
