...
var ShaderProcessor = /** @class */ (function () {
    ...
    ShaderProcessor._PreparePreProcessors = function (options, addGLES) {
        if (addGLES === void 0) { addGLES = true; }
    ...
    ShaderProcessor._ApplyPreProcessing = function (sourceCode, options, engine) {
        ...
        var defines = options.defines;
        var preprocessors = this._PreparePreProcessors(options, false);
        // General pre processing
