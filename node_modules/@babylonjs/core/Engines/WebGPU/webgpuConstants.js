...
(function (QueryType) {
    ...
    QueryType["PipelineStatistics"] = "pipeline-statistics";
    QueryType["Timestamp"] = "timestamp";
})(QueryType || (QueryType = {}));
/** @hidden */
export var PipelineStatisticName;
