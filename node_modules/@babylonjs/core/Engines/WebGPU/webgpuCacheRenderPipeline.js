...
(function (StatePosition) {
    ...
    StatePosition[StatePosition["DepthBiasSlopeScale"] = 2] = "DepthBiasSlopeScale";
    StatePosition[StatePosition["MRTAttachments1"] = 3] = "MRTAttachments1";
    StatePosition[StatePosition["MRTAttachments2"] = 4] = "MRTAttachments2";
    StatePosition[StatePosition["DepthStencilState"] = 5] = "DepthStencilState";
    StatePosition[StatePosition["RasterizationState"] = 6] = "RasterizationState";
    StatePosition[StatePosition["ColorStates"] = 7] = "ColorStates";
    StatePosition[StatePosition["ShaderStage"] = 8] = "ShaderStage";
    StatePosition[StatePosition["VertexState"] = 9] = "VertexState";
    StatePosition[StatePosition["NumStates"] = 10] = "NumStates";
...
var WebGPUCacheRenderPipeline = /** @class */ (function () {
    function WebGPUCacheRenderPipeline(device, emptyVertexBuffer) {
        this._device = device;
    ...
    WebGPUCacheRenderPipeline.prototype.getRenderPipeline = function (fillMode, effect, sampleCount) {
        if (this.disabled) {
    ...
    WebGPUCacheRenderPipeline.prototype.resetDepthCullingState = function () {
        this.setDepthCullingState(false, 2, 1, 0, true, true, 519);
    };
    WebGPUCacheRenderPipeline.prototype.setDepthCullingState = function (cullEnabled, frontFace, cullFace, zOffset, depthTestEnabled, depthWriteEnabled, depthCompare) {
    ...
    WebGPUCacheRenderPipeline.prototype._createPipelineLayout = function (webgpuPipelineContext) {
        ...
        for (var i = 0; i < webgpuPipelineContext.shaderProcessingContext.orderedUBOsAndSamplers.length; i++) {
            ...
            if (setDefinition === undefined) {
                var entries_1 = [];
                var uniformsBindGroupLayout = this._device.createBindGroupLayout({
                    entries: entries_1,
                });
