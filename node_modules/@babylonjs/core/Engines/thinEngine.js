...
var ThinEngine = /** @class */ (function () {
     ...
     */
    ThinEngine.prototype.setState = function (culling, zOffset, force, reverseSide, cullBackFaces, stencil) {
        var _a, _b;
    ...
    ThinEngine.prototype._releaseTexture = function (texture) {
        ...
        (_b = texture._depthStencilTexture) === null || _b === void 0 ? void 0 : _b.dispose();
    };
