...
export declare class Constants {
     ...
     */
    static readonly PREPASS_ALBEDO_TEXTURE_TYPE = 7;
     ...
     */
    /** @hidden */
    static readonly SUBMESH_DRAWWRAPPER_MAINPASS = "bjs_mainpass";
    /** @hidden */
    static readonly SUBMESH_DRAWWRAPPER_SHADOWGENERATOR_PREFIX = "bjs_shadowgenerator_";
    /** @hidden */
    static readonly SUBMESH_DRAWWRAPPER_DEPTHRENDERER_PREFIX = "bjs_depthrenderer_";
    /** @hidden */
    static readonly SUBMESH_DRAWWRAPPER_OUTLINERENDERER_PREFIX = "bjs_outlinerenderer_";
    /**
