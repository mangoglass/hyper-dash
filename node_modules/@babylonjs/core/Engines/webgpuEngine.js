...
var WebGPUEngine = /** @class */ (function (_super) {
    ...
    function WebGPUEngine(canvas, options) {
        ...
        _this._shaderProcessor = _this._getShaderProcessor();
    ...
    Object.defineProperty(WebGPUEngine.prototype, "snapshotRendering", {
        ...
        set: function (activate) {
            ...
            if (activate) {
                ...
                this._snapshotRenderingMode = 0; // need to reset to standard for the recording pass to avoid some code being bypassed
            }
        },
        enumerable: false,
        configurable: true
    ...
    WebGPUEngine.CreateAsync = function (canvas, options) {
        ...
        return new Promise(function (resolve) {
            engine.initAsync(options.glslangOptions).then(function () { return resolve(engine); });
        });
    };
    //------------------------------------------------------------------------------
    //                              Initialization
     ...
     */
    WebGPUEngine.prototype.initAsync = function (glslangOptions) {
        var _this = this;
        var _a;
        return this._initGlslang(glslangOptions !== null && glslangOptions !== void 0 ? glslangOptions : (_a = this._options) === null || _a === void 0 ? void 0 : _a.glslangOptions)
            ...
            _this._textureHelper = new WebGPUTextureHelper(_this._device, _this._glslang, _this._bufferManager);
            ...
            _this._cacheRenderPipeline = new WebGPUCacheRenderPipelineTree(_this._device, _this._emptyVertexBuffer);
     ...
     */
    WebGPUEngine.prototype._getShaderProcessor = function () {
        return new WebGPUShaderProcessor();
    };
    /** @hidden */
    WebGPUEngine.prototype._getShaderProcessingContext = function () {
     ...
     */
    WebGPUEngine.prototype.createEffect = function (baseName, attributesNamesOrOptions, uniformsNamesOrEngine, samplers, defines, fallbacks, onCompiled, onError, indexParameters) {
    ...
    WebGPUEngine.prototype._createPipelineStageDescriptor = function (vertexShader, fragmentShader) {
        return {
            vertexStage: {
    ...
    WebGPUEngine.prototype._compileRawPipelineStageDescriptor = function (vertexCode, fragmentCode) {
    ...
    WebGPUEngine.prototype._compilePipelineStageDescriptor = function (vertexCode, fragmentCode, defines) {
        ...
        var program = this._createPipelineStageDescriptor(vertexShader, fragmentShader);
    ...
    WebGPUEngine.prototype._setInternalTexture = function (name, internalTexture, baseName, textureIndex) {
        ...
        if (this._currentEffect && !this._currentMaterialContext.setTexture(name, internalTexture)) {
            ...
            var availableSampler = webgpuPipelineContext.shaderProcessingContext.availableSamplers[baseName];
            if (availableSampler) {
                ...
                this._currentMaterialContext.textures[name] = {
                    ...
                    wrapU: internalTexture === null || internalTexture === void 0 ? void 0 : internalTexture._cachedWrapU,
                    wrapV: internalTexture === null || internalTexture === void 0 ? void 0 : internalTexture._cachedWrapV,
                    wrapR: internalTexture === null || internalTexture === void 0 ? void 0 : internalTexture._cachedWrapR,
                    anisotropicFilteringLevel: internalTexture === null || internalTexture === void 0 ? void 0 : internalTexture._cachedAnisotropicFilteringLevel,
                    samplingMode: internalTexture === null || internalTexture === void 0 ? void 0 : internalTexture.samplingMode,
                };
            }
        }
    };
    ...
    WebGPUEngine.prototype.endFrame = function () {
        ...
        if (this._mainRenderPassWrapper.renderPass !== null && this._snapshotRenderingPlayBundles) {
            for (var i = 0; i < this._snapshotRenderingMainPassBundleList.length; ++i) {
                this._snapshotRenderingMainPassBundleList[i].run(this._mainRenderPassWrapper.renderPass);
                if (this._snapshotRenderingMode === 1) {
    ...
    WebGPUEngine.prototype.flushFramebuffer = function (reopenPass) {
        ...
        var currentPassType = 0; // 0 if no pass, 1 for rtt, 2 for main pass
        if (this._currentRenderPass) {
            if (this._currentRenderTarget) {
                currentPassType = 1;
                this._endRenderTargetRenderPass();
    ...
    //                              Render Pass
    //------------------------------------------------------------------------------
    WebGPUEngine.prototype._startRenderTargetRenderPass = function (internalTexture, setClearStates, clearColor, clearDepth, clearStencil) {
        var _a, _b, _c;
        ...
        if (internalTexture._attachments && internalTexture._textureArray) {
            ...
            for (var i = 0; i < this._mrtAttachments.length; ++i) {
                ...
                var mrtTexture = internalTexture._textureArray[index - 1];
    ...
    WebGPUEngine.prototype._endRenderTargetRenderPass = function () {
        var _a, _b, _c, _d;
        if (this._currentRenderPass) {
            var gpuWrapper = this._currentRenderTarget._hardwareTexture;
            if (this._snapshotRenderingPlayBundles) {
                (_a = gpuWrapper._bundleLists[gpuWrapper._currentLayer]) === null || _a === void 0 ? void 0 : _a.run(this._currentRenderPass);
                if (this._snapshotRenderingMode === 1) {
                    this._reportDrawCall((_b = gpuWrapper._bundleLists[gpuWrapper._currentLayer]) === null || _b === void 0 ? void 0 : _b.numDrawCalls);
                }
            }
            ...
            if (this.dbgVerboseLogsForFirstFrames) {
                ...
                if (!this._count || this._count < this.dbgVerboseLogsNumFrames) {
                    console.log("frame #" + this._count + " - render target end pass - internalTexture.uniqueId=", (_c = this._currentRenderTarget) === null || _c === void 0 ? void 0 : _c.uniqueId);
                }
            }
    ...
    WebGPUEngine.prototype.bindFramebuffer = function (texture, faceIndex, requiredWidth, requiredHeight, forceFullscreenViewport, lodLevel, layer) {
        ...
        var gpuTexture = hardwareTexture === null || hardwareTexture === void 0 ? void 0 : hardwareTexture.underlyingResource;
        ...
        if (this.dbgVerboseLogsForFirstFrames) {
            ...
            if (!this._count || this._count < this.dbgVerboseLogsNumFrames) {
                console.log("frame #" + this._count + " - bindFramebuffer called - internalTexture.uniqueId=", texture.uniqueId, "face=", faceIndex, "lodLevel=", lodLevel, "layer=", layer, this._rttRenderPassWrapper.colorAttachmentViewDescriptor, this._rttRenderPassWrapper.depthAttachmentViewDescriptor);
            }
        }
    ...
    WebGPUEngine.prototype.unBindFramebuffer = function (texture, disableGenerateMipMaps, onBeforeUnbind) {
        ...
        assert(this._currentRenderTarget === null || (this._currentRenderTarget !== null && texture === this._currentRenderTarget), "unBindFramebuffer - the texture we want to unbind is not the same than the currentRenderTarget! texture id=" + texture.uniqueId + ", this._currentRenderTarget id=" + ((_a = this._currentRenderTarget) === null || _a === void 0 ? void 0 : _a.uniqueId));
        ...
        if (this.dbgVerboseLogsForFirstFrames) {
            ...
            if (!this._count || this._count < this.dbgVerboseLogsNumFrames) {
                console.log("frame #" + this._count + " - unBindFramebuffer called - internalTexture.uniqueId=", texture.uniqueId);
            }
        }
     ...
     */
    WebGPUEngine.prototype.setState = function (culling, zOffset, force, reverseSide, cullBackFaces, stencil) {
        var _a, _b;
    ...
    WebGPUEngine.prototype._draw = function (drawType, fillMode, start, count, instancesCount) {
        ...
        var pipeline = this._cacheRenderPipeline.getRenderPipeline(fillMode, this._currentEffect, this.currentSampleCount);
        var bindGroups = this._cacheBindGroups.getBindGroups(webgpuPipelineContext, this._currentMaterialContext, this._uniformsBuffers);
        if (!this._snapshotRenderingRecordBundles) {
            if (mustUpdateViewport) {
    ...
    /** @hidden */
    WebGPUEngine.prototype._releaseFramebufferObjects = function (texture) { };
    /**
