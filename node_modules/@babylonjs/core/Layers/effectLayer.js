...
var EffectLayer = /** @class */ (function () {
    ...
    EffectLayer.prototype._isReady = function (subMesh, useInstances, emissiveTexture) {
        ...
        if (this._cachedDefines !== join) {
            ...
            this._effectLayerMapGenerationDrawWrapper.setEffect(this._scene.getEngine().createEffect("glowMapGeneration", attribs, ["world", "mBones", "viewProjection",
                "glowColor", "morphTargetInfluences", "boneTextureWidth",
                "diffuseMatrix", "emissiveMatrix", "opacityMatrix", "opacityIntensity",
                "morphTargetTextureInfo", "morphTargetTextureIndices"], ["diffuseSampler", "emissiveSampler", "opacitySampler", "boneSampler", "morphTargets"], join, fallbacks, undefined, undefined, { maxSimultaneousMorphTargets: morphInfluencers }));
        }
    ...
    EffectLayer.prototype._renderSubMesh = function (subMesh, enableAlphaMode) {
        ...
        if (this._useMeshMaterial(renderingMesh)) {
            ...
            var effect_1 = this._effectLayerMapGenerationDrawWrapper.effect;
            engine.enableEffect(this._effectLayerMapGenerationDrawWrapper);
            if (!hardwareInstancedRendering) {
                renderingMesh._bind(subMesh, effect_1, Material.TriangleFillMode);
            }
