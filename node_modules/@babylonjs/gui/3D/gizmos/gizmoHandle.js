...
var SideHandle = /** @class */ (function (_super) {
    ...
    SideHandle.prototype.createNode = function () {
        ...
        var verticalBox = BoxBuilder.CreateBox("sideVert", { width: 1, height: 10, depth: 0.1 }, this._scene);
...
var CornerHandle = /** @class */ (function (_super) {
    ...
    CornerHandle.prototype.createNode = function () {
        ...
        var horizontalBox = BoxBuilder.CreateBox("angleHor", { width: 3, height: 1, depth: 0.1 }, this._scene);
        var verticalBox = BoxBuilder.CreateBox("angleVert", { width: 1, height: 3, depth: 0.1 }, this._scene);
