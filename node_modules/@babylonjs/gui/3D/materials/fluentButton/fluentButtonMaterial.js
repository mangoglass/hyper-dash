...
import { serializeAsColor4, serializeAsVector3, serialize, SerializationHelper } from "@babylonjs/core/Misc/decorators";
...
var FluentButtonMaterial = /** @class */ (function (_super) {
    ...
    function FluentButtonMaterial(name, scene) {
        ...
        _this._blobTexture = new Texture(FluentButtonMaterial.BLOB_TEXTURE_URL, scene, true, false, Texture.NEAREST_SAMPLINGMODE);
        return _this;
    }
