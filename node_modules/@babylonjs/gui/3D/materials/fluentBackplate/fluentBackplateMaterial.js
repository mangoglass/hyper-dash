...
import { SerializationHelper, serialize, serializeAsVector3 } from "@babylonjs/core/Misc/decorators";
...
var FluentBackplateMaterial = /** @class */ (function (_super) {
    ...
    function FluentBackplateMaterial(name, scene) {
        ...
        _this._blobTexture = new Texture(FluentBackplateMaterial.BLOB_TEXTURE_URL, scene, true, false, Texture.NEAREST_SAMPLINGMODE);
        _this._iridescentMap = new Texture(FluentBackplateMaterial.IM_TEXTURE_URL, scene, true, false, Texture.NEAREST_SAMPLINGMODE);
        return _this;
    }
